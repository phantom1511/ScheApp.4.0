...
import com.dastan.scheapp4_0.ui.saturday.SaturdayFragment;
...
public class GroupSaturdayFragment extends Fragment {

    private RecyclerView groupRecyclerView;
    private static GroupSaturdayAdapter groupAdapter;
    private static List<Group> groupList;
    private FloatingActionButton groupSaturdayFab;
    ...
    private void initList() {
        ...
        groupAdapter = new GroupSaturdayAdapter(groupList);
        ...
        groupAdapter.setOnItemClickListeners(new OnItemClickListeners() {
            ...
            public void onClick(int position) {
                ...
                graph.setStartDestination(R.id.navSaturdayDay);
                navController.setGraph(graph);
//                SaturdayFragment saturdayFragment = new SaturdayFragment();
//                getActivity().getSupportFragmentManager().beginTransaction()
//                        .replace(R.id.nav_host_fragment, saturdayFragment)
//                        .addToBackStack(null)
//                        .commit();
//                Intent intent = new Intent(getContext(), SaturdayActivity.class);
//                intent.putExtra("saturdaySchedule", groupList.get(position).getGroupName());
