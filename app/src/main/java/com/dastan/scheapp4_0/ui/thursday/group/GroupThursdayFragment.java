...
import com.dastan.scheapp4_0.ui.thursday.ThursdayFragment;
...
public class GroupThursdayFragment extends Fragment {

    private RecyclerView groupRecyclerView;
    private static GroupThursdayAdapter groupAdapter;
    private static List<Group> groupList;
    private FloatingActionButton groupThursdayFab;
    ...
    private void initList() {
        ...
        groupAdapter = new GroupThursdayAdapter(groupList);
        ...
        groupAdapter.setOnItemClickListeners(new OnItemClickListeners() {
            ...
            public void onClick(int position) {
                ...
                graph.setStartDestination(R.id.navThursdayDay);
                navController.setGraph(graph);
//                ThursdayFragment thursdayFragment = new ThursdayFragment();
//                getActivity().getSupportFragmentManager().beginTransaction()
//                        .replace(R.id.nav_host_fragment, thursdayFragment)
//                        .addToBackStack(null)
//                        .commit();
//                Intent intent = new Intent(getContext(), ThursdayActivity.class);
//                intent.putExtra("thursdaySchedule", groupList.get(position).getGroupName());
